...
async def async_setup_platform(hass, config, async_add_entities, discovery_info=None):
    ...
    async_add_entities([
            FoxESSPVPower(1, coordinator, name, deviceID),
            FoxESSPVPower(2, coordinator, name, deviceID),
            FoxESSPVPower(3, coordinator, name, deviceID),
            FoxESSPVPower(4, coordinator, name, deviceID),
...
class FoxESSPVPower(CoordinatorEntity, SensorEntity):
    ...
    def __init__(self, stringNo, coordinator, name, deviceID):
        super().__init__(coordinator=coordinator)
    ...
    def native_value(self) -> str | None:
        if self.coordinator.data["online"]:
            return self.coordinator.data["raw"][self.dataName]
        return None 
